...
(0, server_ts_1.serve)(async (req) => {
    ...
    try {
        ...
        supabaseAdminClient = (0, supabase_js_2_1.createClient)(supabaseUrl, supabaseServiceRoleKey);
        ...
        if (downloadError)
            throw new Error(`Storage download failed for ${document.storage_path}: ${downloadError.message}`);
        if (!fileData)
        ...
        for (let i = 0; i < chunks.length; i++) {
            ...
            try {
                ...
                const { error: insertChunkError } = await supabaseAdminClient
                    ...
                    metadata: Object.assign(Object.assign({}, (chunk.metadata || {})), { base_class_id: document.base_class_id }),
                    summary_status: 'pending'
                });
                if (insertChunkError)
                    throw insertChunkError; // Throw to be caught by outer catch for this chunk
        ...
        const updatedDocMetadata = Object.assign(Object.assign({}, (document.metadata || {})), { processed_by_function: 'kb-process-textfile', text_content_length: textContent.length, chunks_created: chunksProcessedCount, requires_summarization: chunksProcessedCount > 0 });
        ...
        return new Response(JSON.stringify({
            ...
            headers: Object.assign(Object.assign({}, corsHeaders), { 'Content-Type': 'application/json' }), status: 200
        });
    }
    catch (error) {
        ...
        if (documentId && supabaseAdminClient) {
            try {
                ...
                await updateDocumentStatus(supabaseAdminClient, documentId, 'error', Object.assign(Object.assign({}, ((docForError === null || docForError === void 0 ? void 0 : docForError.metadata) || {})), { processing_error: error.message, error_stack_trace: error.stack }));
            }
            catch (dbUpdateError) {
        ...
        return new Response(JSON.stringify({ error: error.message }), {
            headers: Object.assign(Object.assign({}, corsHeaders), { 'Content-Type': 'application/json' }), status: 500
        });
    }
});
