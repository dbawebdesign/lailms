  ...
  return (
    <div className="flex-1 flex flex-col bg-background overflow-hidden">
      ...
      <div className="flex-1 p-8 flex flex-col overflow-hidden">
        ...
        <div className="flex-1 relative border border-divider rounded-lg">
          <div className="absolute inset-0 overflow-auto">
            <table className="border-collapse w-full" style={{ minWidth: 'max-content' }}>
              {/* Table Header */}
              <thead className="bg-surface/50 sticky top-0 z-10">
                <tr>
                  <th className="text-left p-3 w-16 bg-background sticky z-20 border-r border-b border-divider" style={{ left: 0 }}>
                    <Checkbox
                  ...
                  <th className="text-center p-3 w-20 bg-surface/50 border-r border-b border-divider">
              ...
              <tbody className="divide-y divide-divider">
                {filteredStudents.map((student) => (
                  ...
                  >
                    {/* Checkbox */}
                    <td className="p-3 bg-background group-hover:bg-surface/30 transition-airy sticky z-10 border-r border-divider" style={{ left: 0 }}>
                      <Checkbox
